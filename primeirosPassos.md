...
> Usar o pino 13 para verificar o controle de um LED

> NOTA IMPORTANTE: o pino 13 é o único em que podes colcoar um led diretamente sem uma resistência em série;

3. Controlar o LED embebido na placa arduino, usando o **serial monitor**

> código: const int LED = 13; // Led embebido na placa Arduino
